...
const AssetsBox = () => {
  ...
  return (
    <div className="rounded-2xl bg-white drop-shadow-md p-6 gap-6 flex flex-col">
      <div className="flex itemc-center gap-6 pointer-events-auto">
...
const DownloadButton = () => {
  return (
    <button className="rounded-lg bg-indigo-500 hover:bg_indigo-600 transition-colors duration-300 text-white font-medium px-4 py-3 pointer-events-auto">
      Download
    </button>
  );
};
