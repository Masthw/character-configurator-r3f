...
const RandomizeButton = () => {
  ...
  return (
    <button
      className="rounded-lg bg-indigo-500 hover:bg_indigo-600 transition-colors duration-300 text-white font-medium px-4 py-3 pointer-events-auto drop-shadow-md"
      onClick={randomize}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
